...
public class SharePointService
{
    ...
    private static readonly string[] _regretPhrases =
        ["regret", "no stock", "unable to supply", "cannot supply", "unable to quote", "cannot quote",
         ...
         "don't stock", "do not offer", "not able to offer", "unable to offer"];
    ...
    public async Task<QcListResult> ReadQcListAsync()
    {
        ...
        return new QcListResult(outputColumns, rows, itemIds, list.LastModifiedDateTime?.UtcDateTime, shortDays, longDays);
    }
