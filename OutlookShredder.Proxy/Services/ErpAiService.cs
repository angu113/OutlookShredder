...
public class ErpAiService
{
    ...
    private const string SystemPromptText = """
        ...
        DOCUMENT NUMBER
        The document_number field MUST be our own ERP reference — it always starts with HSK- or 020803-.
        Look for it in the document header or footer, e.g.:
          "Invoice No: HSK-INV-001234"   "Quotation: HSK-QU-5678"   "Order: 020803-SO-0099"
        Return the full reference including its prefix (e.g. "HSK-INV-001234").
        CRITICAL: NEVER put the customer's PO number or their reference in document_number.
        If you cannot find an HSK- or 020803- reference anywhere in the document, set
        is_erp_document = false — such a document was not generated by our ERP system.

        CUSTOMER INFORMATION
        Extract the customer name (company the document is addressed to).
        Any customer-assigned purchase order or reference number (e.g. "Customer PO: 12345",
        "Your Ref:", "Cust. Order:", "Customer Reference:") goes in customer_reference — NOT
        in document_number.
    ...
    private static readonly JsonElement _toolJson = JsonDocument.Parse("""
        {
          ...
          "input_schema": {
            ...
            "properties": {
              ...
              "document_type":      { "type": ["string","null"],   "enum": ["Quotation","SalesOrder","PickingSlip","PurchaseOrder","Invoice","CreditNote","Payment","ShippingNote","Unknown",null] },
    ...
    private static readonly JsonElement _geminiSchema = JsonDocument.Parse("""
        {
          ...
          "properties": {
            ...
            "document_type":      { "type": "string",  "nullable": true, "enum": ["Quotation","SalesOrder","PickingSlip","PurchaseOrder","Invoice","CreditNote","Payment","ShippingNote","Unknown"] },
